...
public class Vivero implements IVivero {
	...
	/**
	 * Clase contenedora del sistema Administra los productos, servicios, clientes,
	 * empleados del sistema. Invoca a los metodos que gestionan los pedidos.
	 * Contiene las colecciones (HashMap, HashSet) que almacenan la informacion del
	 * sistema
	 */
	...
	/**
	 * Metodo generico que permite ingresar un nuevo producto, servicio, cliente u
	 * empleado al sistema
	 * 
	 * @param Dato generico
	 */
	...
	/**
	 * Metodo generico que permite buscar un producto, servicio, cliente u empleado
	 * en el sistema
	 * 
	 * @param Dato generico
	 * @return String
	...
	/**
	 * Metodo generico que permite eliminar un producto, servicio, cliente u
	...
	/**
	 * Verifica que se encuentre o no registrado un determinado empleado, retornando
	...
	/**
	 * //Muestra el nombre, clasificacion, stock, precio y codigo de los productos
	 * del sistema
	 * 
	 * @return String
	 */
	public String mostrarProductoResumido() {
		...
		while (it.hasNext()) {
			...
			for (int i = 0; i < productos.size(); i++) {
				builder.append("Nombre producto: " + productos.get(i).getNombre() + " // Clasifiacion: "
						+ productos.get(i).getClasificacion() + " // Precio: " + productos.get(i).getPrecio()
						+ " // Stock actual: " + productos.get(i).getStock() + " // Codigo: "
	...
	public String mostrarServicioResumido() {
		...
		while (it.hasNext()) {
			...
			builder.append("Nombre servicio: " + servicio.getNombre() + " // Precio: " + servicio.getPrecio()
	...
	/**
	 * Permite adquirir un producto e ingresarlo al pedido del cliente
	 * correspondiente
	 * 
	 * @param Producto
	 * @param Cliente
	...
	/**
	 * Permite adquirir un servicio e ingresarlo al pedido del cliente
	 * correspondiente
	 * 
	 * @param String
	 * @param Cliente
	...
	/**
	 * Valida que el dato ingresado sea valido y captura la excepcion en caso de ser
	 * preciso
	 * 
	...
	/**
	 * Valida que el dato ingresado sea valido, lanzando una excepcion que sera
	 * capturada por {@link #pedirCantidadCompra(int)}
	 * 
	...
	/**
	 * Invoca al metodo que establece el metodo de pago de un pedido existentes en
	 * el sistema
	 * 
	...
	/**
	 * Invoca al metodo que busca y retorna el pedido impago de un cliente en caso
	 * de existir
	 * 
	...
	/**
	 * Invoca al metodo que muestra el pedido impago de un cliente en caso de
	 * existir
	 * 
	...
	/**
	 * Invoca al metodo que verifica que el carrito de un pedido no se encuentre
	 * vacio
	 * 
	...
	/**
	 * Invoca al metodo que muestra los totales bruto, neto y medio de pago
	 * correspondiente al pedido impago de un cliente
	 * 
	...
	/**
	 * Invoca al metodo que establece el empleado que administro el pago de un
	 * pedido
	 * 
	...
	/**
	 * Retorna un ArrayList con los productos de la clasificacion solicitada (para
	...
	/**
	 * Permite acceder al catalogo de productos (utilizado para la escritura del
	...
	/**
	 * Permite acceder al catalogo de servicios (utilizado para la escritura del
	 * archivo base de datos)
	 * 
	...
	/**
	 * Permite acceder a la lista de clientes (utilizado para la escritura del
	 * archivo base de datos)
	 * 
	 * @return HashSet
	 */
	...
	/**
	 * Permite acceder a la lista de empleados (utilizado para la escritura del
	 * archivo base de datos)
	 * 
	 * @return HashSet
	 */
	...
	/**
	 * Permite acceder a la lista de pedidos (utilizado para la escritura del
	 * archivo base de datos)
	 * 
	 * @return LinkedList
	 */
	...
	/**
	 * Invoca al metodo que permite ingresar un pedido al sistema (utilizado en la
	 * lectura del archivo base de datos)
	 * 
