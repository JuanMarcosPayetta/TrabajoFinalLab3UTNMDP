...
public abstract class Planta extends Producto implements IEstablecerPrecioPlanta{
	...
	public Planta(String nombre, String marca, int stock, String descripcion,
			int mesesDeVida, String estacionPlantacion, String habitat, int altura, boolean flor,
			String nivelExposicionSolar, String tipoRaiz, boolean aromatica) {
	...
	public String toString() {
		return super.toString()+", Meses de ida: " + mesesDeVida + ", Estacion de plantacion: " + estacionPlantacion + ", Habitat: "
				+ habitat + ", Altura: " + altura +"\n"+ ", Posee flor: " + flor + ", Nivel de Exposicion Solar: "
				+ nivelExposicionSolar + ", Tipo de raiz: " + tipoRaiz + ", Es aromatica: " + aromatica
