...
public class PlantaAcuatica extends Planta {
	...
	public PlantaAcuatica(String nombre, String marca, double precio, int stock, String descripcion, int mesesDeVida,
			...
			String tipoRaiz, boolean aromatica, String tipoDeAgua, int temperaturaAgua, String durezaAgua,
			String tipo) {
	...
	/**
	 * Valida que el tipo de agua pasado por parametro sea correcto, lanzando una
	 * excepcion que es capturada por {@link #validarTipoDeAguaLlamada(String)}
	 * 
	 ...
	 */
	private static void validarTipoDeAgua(String tipo)
	 ...
	 * {@link #validarTempAguaLlamada(Integer)}
	 * 
	 ...
	 */
	private static void validarTempAgua(Integer temperatura)
			throws DatoNumeroException, NullPointerException, NumberFormatException {
		if (temperatura == null) {
			...
			throw new DatoNumeroException(
					DatoNumeroException.VALORFUERADELRANGOEXCEPTION + ": entre los 20�C y los 27�C");
		}
	}
	...
	/**
	 * Valida que la dureza del agua pasada por parametro sea correcta, lanzando una
	 * excepcion que es capturada por {@link #validarDurezaAguaLlamada(String)}
	 * 
	 ...
	 * @throws InputMismatchException
	 */
	private static void validarDurezaAgua(String durezaAgua)
			throws NullPointerException, CadenaInvalidaException, InputMismatchException {
	 ...
	 * Valida que el tipo de planta acuatica pasado por parametro sea correcto,
	 * lanzando una excepcion que es capturada por
	 * {@link #validarTipoPlantaLlamada(String)}
	 * 
	 * @see #validarTipoPlantaLlamada(String)
	 * @param String
	 * @throws NullPointerException
	 ...
	 * @throws InputMismatchException
	 */
	private static void validarTipoPlanta(String tipoPlanta)
			throws NullPointerException, CadenaInvalidaException, InputMismatchException {
		ArrayList<String> tipos = new ArrayList<String>();
		tipos.add("flotante");
	...
	public String toString() {
		return super.toString() + ", Tipo del planta: " + tipo + ", Tipo De Agua: " + tipoDeAgua
				+ ", Temperatura del Agua: " + temperaturaAgua + ", Dureza del Agua: " + durezaAgua;
	}
