...
public class SanidadVegetal extends Producto implements IEstablecerPrecioProductoInerte {
	...
	/**
	 * Valida que el String ingresado sea valido y lanza una excepcion que es
	 * capturada por {@link #validarSanidadLlamada(String)}
	 * 
	 ...
	 */
	private static void validarSanidad(String funcion)
	...
	/**
	 * Establece la funcion correspondiente al producto de sanidad vegetal,
	 * validando que sea correcta
	 * 
	 * @see #validarSanidadLlamada(String)
	 * @param String
	 * @return String
	...
	/**
	 * Establece la cantidad de centimetros cubicos de producto, validando que sea
	 * correcto
	 * 
	...
	/**
	 * Compara dos objetos de sanidad vegetal, indicando si son iguales, mayor o
	 * menor
	 * 
