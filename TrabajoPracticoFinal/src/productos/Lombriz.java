...
public class Lombriz extends ProductoOrganico {
	...
	public Lombriz(String nombre, String marca, int stock, String descripcion, int gramos, String especie) {
	 ...
	 */
	private static void validarEspecieLombriz(String especie)
		...
		if (especie == null) {
			throw new NullPointerException(
					"Error, ingrese una especie de lombriz valida (rayada, dendra, roja, comun)");
	...
	/**
	 * Setea el valor que indica la especie de la lombriz, validando que sea
	 * correcta
	 * 
	 * @see #validarEspecieLombrizLlamada(String)
	 * @param String
