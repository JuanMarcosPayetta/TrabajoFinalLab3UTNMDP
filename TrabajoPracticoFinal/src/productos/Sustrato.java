...
/**
 * 
 * Atributos de los productos clasificacion Sustrato
 *
 */
public class Sustrato extends ProductoOrganico {
	...
	public Sustrato(String nombre, String marca, int stock, String descripcion, int gramos, boolean abonada,
			String tipoDeSuelo) {
	...
	/**
	 * Valida que el tipo de suelo pasado por parametro sea correcto, lanzando una
	 * excepcion que sera capturada por {@link #validarTipoSueloLlamada(String)}
	 * 
	 ...
	 */
	private static void validarTipoSuelo(String suelo)
		...
		if (suelo == null) {
			...
			throw new InputMismatchException(
					"Error, ingrese un tipo de suelo valido (arenoso, calizo, humifero, arcilloso, pedregoso, mixto)");
		}
	...
	/**
	 * Setea el valor que indica si el sustrato esta abonado o no, validando que sea
	 * correcto
	 * 
