...
public class Hierba extends PlantaTerrestre {
	...
	public Hierba(String codigo, String nombre, String marca, String clasificacion, double precio, int stock,
		...
		super(codigo, nombre, marca, clasificacion, precio, stock, descripcion, mesesDeVida, estacionPlantacion,
				habitat, altura, flor, nivelExposicionSolar, tipoRaiz, aromatica, cantidadFertilizante, fruto, semilla,
				interior, epocaDePoda, cantidadRiego, especie);
	...
	public Hierba(String nombre, String marca, double precio, int stock, String descripcion, int mesesDeVida,
		...
		super(nombre, marca, precio, stock, descripcion, mesesDeVida, estacionPlantacion, habitat, altura, flor,
				nivelExposicionSolar, tipoRaiz, aromatica, fruto, semilla, interior, especie);
		this.tipoDeTallo = tipoDeTallo;
		this.comestible = comestible;
		this.medicinal = medicinal;
	...
	/**
	 * Valida que el tipo de tallo pasado por parametro sea correcto, lanzando una
	 * excepcion que es capturada por {@link #validarTipoTalloLlamada(String))}
	 * 
	 ...
	 */
	private static void validarTipoTallo(String tipo)
			throws CadenaInvalidaException, NullPointerException, InputMismatchException {
		...
		if (tipo == null) {
			...
			throw new InputMismatchException(
					"Ingrese un tipo de tallo valido (erguido, rastrero, voluble, segmentado)");
		}
	}
	...
	/**
	 * Setea el valor para indicar si la hierba es comestible o no, validando que
	 * sea correcto o no
	 * 
	...
	/**
	 * Setea el valor para indicar si la hierba es medicinal o no, validando que sea
	 * correcto
	 * 
	 * @see #validarBooleanLlamada(Boolean)
	 * @param boolean
	...
	public String toString() {
		return super.toString() + ", Tipo de tallo: " + tipoDeTallo + ", Es comestible: " + comestible
				+ ", Es medicinal: " + medicinal;
	}

	/**
	 * Establece la cantidad de litros de agua de una hierba segun su desarrollo y
	 * habitat
	 */
	@Override
	...
	/**
	 * Establece la cantidad de fertilizante segun sea una planta joven o mas
	 * desarrollada (en gramos)
	 * 
