...
public class HerramientaNoManual extends HerramientaJardineria {
	...
	public HerramientaNoManual(String codigo, String nombre, String marca, String clasificacion, double precio,
			int stock, String descripcion, String material, String funcion, int potencia, String tipoMotor,
			String consumo) {
	...
	public HerramientaNoManual(String nombre, String marca, int stock, String descripcion, String material,
	...
	/**
	 * Valida que el tipo de motor pasado por parametro sea correcto (electirco o a
	 * combustible)
	 * 
	...
	/**
	 * Valida que el tipo de motor pasado por parametro sea correcto, lanzando una
	 * excepcion que sera capturada por {@link #validarMotorLlamada(String)}
	 * 
	 ...
	 */
	private static void validarMotor(String motor)
	 ...
	 * {@link #validarConsumoLlamada(String))}
	 * 
	 ...
	 * @throws InputMismatchException
	 */
	private static void validarConsumo(String consumo)
			throws NullPointerException, CadenaInvalidaException, InputMismatchException {
	...
	/**
	 * Setea el valor que indica la potencia de la herramienta, validando que sea
	 * correcto
	 * 
	...
	/**
	 * Setea el valor que indica el tipo de motor de la herramienta, validando que
	 * sea correcto
	 * 
	 * @see #validarMotorLlamada(String)
	 * @param String
	...
	/**
	 * Setea el valor que indica el consumo de la herramienta, validando que sea
	 * correcto
	 * 
	 * @see #validarConsumoLlamada(String)
	 * @param String
