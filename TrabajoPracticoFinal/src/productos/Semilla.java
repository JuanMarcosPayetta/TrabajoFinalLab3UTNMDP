...
public class Semilla extends ProductoOrganico {
	...
	public Semilla(String nombre, String marca, int stock, String descripcion, int gramos, String destino) {
	...
	/**
	 * Valida que el valor pasado por parametro sea correcto, lanzando una excepcion
	 * que sera capturada por {@link #validarDestinoSemillaLlamada(String)}
	 * 
	 ...
	 */
	private static void validarDestinoSemilla(String destino)
	...
	/**
	 * Setea el valor que indica el destino de la semilla, validando que sea
	 * correcto
	 * 
	 * @see #validarDestinoSemillaLlamada(String)
	 * @param String
