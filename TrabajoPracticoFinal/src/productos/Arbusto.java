...
public class Arbusto extends PlantaTerrestre {
	...
	public Arbusto(String codigo, String nombre, String marca, String clasificacion, double precio, int stock,
			...
			boolean semilla, boolean interior, String epocaDePoda, int cantidadRiego, String especie, String tipoDeHoja,
			boolean trepador) {
	...
	public Arbusto(String nombre, String marca, double precio, int stock, String descripcion, int mesesDeVida,
			...
			String tipoDeHoja, boolean trepador) {
	...
	/**
	 * Valida que el tipo de hoja pasado por parametro sea correcto, lanzando una
	 * excepcion que es capturada por {@link #validarTipoHojaLLamada(String)}
	 * 
	 ...
	 */
	private static void validarTipoHoja(String tipo)
	...
	/**
	 * Setea el valor del arbusto para indicar si es trepador o no, validando que
	 * sea valido
	 * 
	...
	/**
	 * Establece la cantidad de litros de agua por arbusto segun su desarrollo y
	 * habitat
	 * 
	 * @see #getMesesDeVida()
	 * @see #getHabitat()
	...
	public void establecerEpocaPoda() {
		...
		if (isFlor()) {
			...
			if (getTipoDeHoja().equalsIgnoreCase("caduca")) {
				setEpocaDePoda("Fin de Oto�o - Inicio del Invierno");
			} else {
	...
	/**
	 * Establece la cantidad de fertilizante indicado para el arbusto segun sea una
	 * planta joven o mas desarrollada (en gramos)
	 * 
	 * @see #getMesesDeVida()
